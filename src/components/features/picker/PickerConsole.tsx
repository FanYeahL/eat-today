...
export default function PickerConsole({
  ...
  const lgJustify = align === "center" ? "lg:justify-center" : "lg:justify-start";
  return (
    <div className="relative z-10 flex min-h-screen w-full flex-col lg:flex-row">
      ...
      />
      {/* 操作台栏：手机满宽单列居中，桌面右栏内容列 */}
      <div
        className={`relative mx-auto flex w-full max-w-md flex-1 flex-col lg:max-w-[440px] ${lgJustify} ${className}`}
      >
        {children}
      </div>
    </div>
